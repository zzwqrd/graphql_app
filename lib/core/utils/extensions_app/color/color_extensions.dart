...
extension ColorExtensions on dynamic {
  ...
  Color get mainTextColor => const Color(0xFF1F1F39);
  Color get mainBorderColor => const Color(0xffEFF0F6);
  Color get mainTealColor => const Color(0xff1CB7CD);
  Color get tealColor => Color(0xff1CB7CD);
  Color get deSelectedColor => Color(0xff6E7191);
  Color get deepGreenColor => Color(0xff00C76A);
  Color get returnColor => Color(0xff01BE5F);
  Color get blueColor1 => Color(0xff01BE5F);
  Color get pendingColor => Color(0xffF6A609);
  Color get paidColor => Color(0xffD3FFE5);
  Color get unpaidColor => Color(0xffFFE8E8);
  Color get refundColor => Color(0xffEAF6FF);
  Color get refundTextColor => Color(0xff007FE3);
  Color get activeColor => Color(0xff2AC769);
  Color get onthewayColor => Color(0xff007FE3);
  Color get grayColor => Color(0xffD9DBE9);
  Color get redColor => Color(0xffFF6262);
  Color get redColor1 => Color(0xffF23E14);
  Color get redColor2 => Color(0xffFB4E4E);
  ...
  Color get textColor => const Color(0xff1F1F39);
  Color get borderColor => const Color(0xffEFF0F6);

  // Neutral Colors
  Color get backgroundColorApp => const Color(0xFFF5F5F5);
