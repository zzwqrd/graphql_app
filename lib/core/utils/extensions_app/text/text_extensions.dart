...
extension SmartTextExtensions on dynamic {
  ...
  Text styled(TextStyle style, {int? maxLines, TextOverflow? overflow}) {
    if (this is Text) {
  ...
  Text textCatogory({Color? color}) => withStyle(
    fontSize: 10.sp,
    color: color ?? navigatorKey.currentContext.mainColor,
  ...
  Text h7WithoutStyle({Color? color, TextStyle? style}) => styled(
    TextStyle(
      fontSize: 14,
      fontWeight: FontWeight.bold,
  ...
  Text productItemName({Color? color, TextStyle? style}) => styled(
    const TextStyle(
      fontSize: 12,
      fontWeight: FontWeight.w500,
    ).merge(style).copyWith(color: color),
