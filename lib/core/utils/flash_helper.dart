...
class FlashHelper {
  ...
  static void failToast(String msg) {
    FlashHelper.showToast(msg, type: MessageTypeTost.fail);
  }
  ...
  static void warningToast(String msg) {
    FlashHelper.showToast(msg, type: MessageTypeTost.warning);
  }
  ...
  static String _getToastIcon(MessageTypeTost msgType) {
    return MyAssets.icons.iconAppG.path;
    // switch (msgType) {
